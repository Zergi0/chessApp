...
{
    public class QueenTests : IDisposable
    {
        ...
        {
            List<PieceImport> pieces = new() { new(Colour.white, new Location(fromX, fromY), "queen") };
        ...
        {
            List<PieceImport> pieces = new() { new(colourSelf, new Location(fromX, fromY), "queen"), new(colourOpponent, new Location(toX, toY), "pawn") };
            Location to = new Location(toX, toY);
            chessService.CreateCustomBoard(pieces);
